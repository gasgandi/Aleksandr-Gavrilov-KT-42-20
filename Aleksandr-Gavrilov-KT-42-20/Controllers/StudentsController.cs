...
namespace Aleksandr_Gavrilov_KT_42_20.Controllers
{
    ...
    public class StudentsController : ControllerBase
    {
        ...
        public IActionResult CreateStudent([FromBody] Aleksandr_Gavrilov_KT_42_20.Models.Student student)
        {
        ...
        public IActionResult DeleteGroup(string groupName, Aleksandr_Gavrilov_KT_42_20.Models.Group updatedGroup)
        {
            var existingGroup = _context.Groups.FirstOrDefault(g => g.GroupName == groupName);
